                    ...
                    for (int c = 0; c < columnCnt; c++)
                    {
                        ...
                        switch (c)
                        {
                            case 0:
                                ...
                                row.Cells[c].SetCellValue(GTF_STFM.Util.Utils.FormatDate(json["INVOICE_DATE"].ToString(), 2));
                                break;
                            case 1:
                            ...
                            case 3:
                                row.Cells[c].CellStyle = sDL;
                                row.Cells[c].SetCellValue(GTF_STFM.Util.Utils.FormatDocId(json["DOC_ID"].ToString()));
                                break;
                            case 4:
                                row.Cells[c].CellStyle = sDC;
                                row.Cells[c].SetCellValue(GTF_STFM.Util.Utils.FormatDate(json["ISSUE_DATE"].ToString(), 2));
                                break;
                            case 5:
                                row.Cells[c].CellStyle = sDC;
                                row.Cells[c].SetCellValue(GTF_STFM.Util.Utils.FormatTime(json["ISSUE_TIME"].ToString(), "12"));
                                break;
                            case 6:
                                row.Cells[c].CellStyle = sDC;
                            ...
                            case 9:
                                ...
                                {
                                    row.Cells[c].SetCellValue(status + " (" + GTF_STFM.Util.Utils.FormatDate(json["VOID_DATE"].ToString(), 2) + ")");
                                }
                                else
                                {
