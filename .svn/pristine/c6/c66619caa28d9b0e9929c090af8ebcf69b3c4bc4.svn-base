...
namespace GTF_GRIM_SG.Util
{
    class BixolonPrinterUtil
    {
        ...
        void PrintHeader()
        {
            ...
            string temp = " " + GTF_LITTLE_INDIA.Properties.Resource_Print.Title_CentralRefundAgency;
        ...
        {
            string temp = " " + GTF_LITTLE_INDIA.Properties.Resource_Print.Title_RetailerDetails;
            temp = temp.PadRight(28);
        ...
        {
            string temp = " " + GTF_LITTLE_INDIA.Properties.Resource_Print.Title_DocId;
            temp = temp.PadRight(28);
        ...
        {
            string temp = " " + GTF_LITTLE_INDIA.Properties.Resource_Print.Title_TouristPassport;
            temp = temp.PadRight(28);
        ...
        {
            string temp = " " + GTF_LITTLE_INDIA.Properties.Resource_Print.Title_Purchase;
            temp = temp.PadRight(28);
        ...
        {
            string temp = " " + GTF_LITTLE_INDIA.Properties.Resource_Print.Title_Identifier;
            temp = temp.PadRight(28);
            ...
            temp = " " + GTF_LITTLE_INDIA.Properties.Resource_Print.Title_Information;
            temp = temp.PadRight(28);
        }

        void PrintFooter(string foramt_doc_id)
        {
            string temp = " " + GTF_LITTLE_INDIA.Properties.Resource_Print.Title_Information;
            temp = temp.PadRight(28);
