    ...
    public partial class Logbook : UserControl
    {
            ...
            try
            {
                ...
                if (!strResult.Equals(""))
                {
                    ...
                    foreach (JObject json in searchArr.Children<JObject>())
                    {
                        ...
                        GRD_LOG.Rows[nRow + i].Cells["DateOfInvoice"].Value = GTF_STFM.Util.Utils.FormatDate(json["INVOICE_DATE"].ToString(), 2);
                        ...
                        GRD_LOG.Rows[nRow + i].Cells["DocID"].Value = (json["DOC_ID"].ToString().Length == 20 ? GTF_STFM.Util.Utils.FormatDocId(json["DOC_ID"].ToString()) : json["DOC_ID"].ToString());
                        GRD_LOG.Rows[nRow + i].Cells["DateOfIssue"].Value = GTF_STFM.Util.Utils.FormatDate(json["ISSUE_DATE"].ToString(), 2);
                        GRD_LOG.Rows[nRow + i].Cells["TimeOfIssue"].Value = GTF_STFM.Util.Utils.FormatTime(json["ISSUE_TIME"].ToString(), "12");
                        ...
                        {
                            GRD_LOG.Rows[nRow + i].Cells["Status"].Value = status + " (" + GTF_STFM.Util.Utils.FormatDate(json["VOID_DATE"].ToString(), 2) + ")";
                        }
                        else
                        {
        ...
        public void PrintLogBookHeaderInfo(PrintPageEventArgs e, ref float yPos)
        {
            ...
            try
            {
                ...
                {
                    printDate = "Date : " + GTF_STFM.Util.Utils.FormatDate(Util.Utils.FormatConvertDate(txt_StartDate.Text), 2);
                }
                else
                {
                    printDate = "Date : " + GTF_STFM.Util.Utils.FormatDate(Util.Utils.FormatConvertDate(txt_StartDate.Text), 2) + " ~ " + GTF_STFM.Util.Utils.FormatDate(Util.Utils.FormatConvertDate(txt_EndDate.Text), 2);
                }
                ...
                e.Graphics.DrawString(GTF_LITTLE_INDIA.Properties.Resource_Print.Global, strFont, sbr, rect1, strFormat);

                strFont = new Font("Century Gothic", 12, FontStyle.Bold);
                rect1 = new Rectangle(headerWidth - 120 + 67, (int)yPos, 79, strFont.Height);
                e.Graphics.DrawString(GTF_LITTLE_INDIA.Properties.Resource_Print.Taxfree, strFont, sbr, rect1, strFormat);
        ...
        public void PrintLogBookDataTable(PrintPageEventArgs e, ref float yPos, JArray dataArray)
        {
            ...
            try
            {
                ...
                {
                    //Constants.LOGGER_MAIN.Info("%%% Doc ID : " + GTF_STFM.Util.Utils.FormatDocId(json["DOC_ID"].ToString()));
                    ...
                    rect = new Rectangle(strIdx, (int)yPos, headerSize, headerHeight);
                    e.Graphics.DrawRectangle(Pens.Black, rect);
                    e.Graphics.DrawString(GTF_STFM.Util.Utils.FormatDate(json["INVOICE_DATE"].ToString(), 2), strFont, Brushes.Black, rect, strFormat);
                    ...
                    e.Graphics.DrawRectangle(Pens.Black, rect);
                    rect = new Rectangle(strIdx + padding, (int)yPos, headerSize, headerHeight);
                    e.Graphics.DrawString((json["DOC_ID"].ToString().Length == 20 ? GTF_STFM.Util.Utils.FormatDocId(json["DOC_ID"].ToString()) : json["DOC_ID"].ToString()), strFont, Brushes.Black, rect, leftFormat);
                    ...
                    rect = new Rectangle(strIdx, (int)yPos, headerSize, headerHeight);
                    e.Graphics.DrawRectangle(Pens.Black, rect);
                    e.Graphics.DrawString(GTF_STFM.Util.Utils.FormatDate(json["ISSUE_DATE"].ToString(), 2), strFont, Brushes.Black, rect, strFormat);
                    ...
                    rect = new Rectangle(strIdx, (int)yPos, headerSize, headerHeight);
                    e.Graphics.DrawRectangle(Pens.Black, rect);
                    e.Graphics.DrawString(GTF_STFM.Util.Utils.FormatTime(json["ISSUE_TIME"].ToString(), "12"), strFont, Brushes.Black, rect, strFormat);
                    ...
                    if (status.Equals("Voided"))
                    {
                        e.Graphics.DrawString(status + " (" + GTF_STFM.Util.Utils.FormatDate(json["VOID_DATE"].ToString(), 2) + ")", strFont, Brushes.Black, rect, strFormat);
                    }
                    else
                    {
